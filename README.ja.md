...
**プレリリース / 雛形整備中。** リポジトリ構成・ドキュメント・リリースツーリング・公開 API は整っている。エンコーダ / デコーダ本体は未実装。[CHANGELOG.md](CHANGELOG.md) 参照。
...
| | **PCMFlowG711**(本ライブラリ) | [PCMFlowG722](https://github.com/tanakamasayuki/PCMFlowG722)(予定) | [PCMFlowOpus](https://github.com/tanakamasayuki/PCMFlowOpus) |
|---|---|---|---|
...
同じ 64 kbps で **HD voice 広帯域音声**が欲しく、フットプリントの中程度の増加を許容できるなら [G.722(PCMFlowG722)](https://github.com/tanakamasayuki/PCMFlowG722) を選ぶ — **計画中の姉妹ライブラリ、未リリース**。G.722 はファミリー内で G.711 と Opus の中間に位置する。
